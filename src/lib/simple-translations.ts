...
export const translations = {
  en: {
    ...
    trusted_uae_institution:
      "A trusted UAE financial institution providing transparent, science-based financial wellness assessment.",
    get_personalized_insights:
      "Get personalized insights to strengthen your financial future.",

    // Features
    transparent_scoring: "Transparent Scoring",
    transparent_scoring_description:
      "Understand exactly how your score is calculated with clear explanations for each factor.",
    privacy_protected: "Privacy Protected",
    privacy_protected_description:
      "Your data is handled according to UAE PDPL regulations with full consent management.",
    personalized_insights: "Personalized Insights",
    personalized_insights_description:
      "Receive tailored recommendations based on your unique financial situation and goals.",
    progress_tracking: "Progress Tracking",
    progress_tracking_description:
      "Save your results with just email and date of birth. No passwords needed to track your progress over time.",
    ...
    uae_specific_insights_description:
      "Tailored for the UAE market with localized recommendations that consider Emirates-specific financial products, regulations, and cultural factors.",
    ...
    join_thousands:
      "Join thousands of UAE residents who have strengthened their financial future with our comprehensive assessment.",
    save_results_no_passwords:
      "Save your results with just your email and date of birth - no passwords required!",
    ...
    provide_information_personalize:
      "Please provide your information to personalize your financial health assessment",
    personal_information: "Personal Information",
    basic_demographic_information:
      "Your basic demographic information for assessment customization",
    name: "Name",
    ...
    professional_financial_background:
      "Your professional and financial background",
    ...
    detailed_view_of_all_assessments:
    ...
    sending_email_report: "Sending email report...",
    email_sent_successfully: "Email sent successfully!",
    email_service_being_configured: "Email service being configured",
    failed_to_send_email: "Failed to send email",
    email_address_not_available: "Email address not available",
    no_assessment_data_found: "No assessment data found",
    loading_your_assessments: "Loading your assessments...",

    // Category names for history page
    income_stream: "Income Stream",
    savings_habit: "Savings Habit",
    emergency_savings: "Emergency Savings",
    debt_management: "Debt Management",
    retirement_planning: "Retirement Planning",
    protecting_your_family: "Protecting Your Family",

    // Chart labels
    score: "Score",
    current_score_chart: "Current Score",
  ...
  ar: {
    ...
    trusted_uae_institution:
      "مؤسسة مالية إماراتية موثوقة تقدم تقييماً شفافاً ومبنياً على العلم للعافية المالية.",
    get_personalized_insights: "احصل على رؤى مخصصة لتعزيز مستقبلك المالي.",

    // Features
    transparent_scoring: "تسجيل شفاف",
    transparent_scoring_description:
      "افهم بالضبط كيف يتم حساب درجتك مع شرح واضح لكل عامل.",
    privacy_protected: "حماية الخصوصية",
    privacy_protected_description:
      "يتم التعامل مع بياناتك وفقاً لقانون حماية البيانات الإماراتي مع إدارة كاملة للموافقة.",
    personalized_insights: "رؤى مخصصة",
    personalized_insights_description:
      "احصل على توصيات مخصصة بناءً على وضعك المالي وأهدافك الفريدة.",
    progress_tracking: "تتبع التقدم",
    progress_tracking_description:
      "احفظ نتائجك بمجرد البريد الإلكتروني وتاريخ الميلاد. لا حاجة لكلمات مرور لتتبع تقدمك عبر الزمن.",
    ...
    uae_specific_insights_description:
      "مصمم خصيصاً للسوق الإماراتي مع توصيات محلية تأخذ في الاعتبار المنتجات المالية واللوائح والعوامل الثقافية الخاصة بالإمارات.",
    uae_banking_products_services: "المنتجات والخدمات المصرفية الإماراتية",
    adcb_emirates_nbd_partnerships:
      "شراكات بنك أبوظبي التجاري وبنك الإمارات دبي الوطني",
    ...
    join_thousands:
      "انضم إلى آلاف المقيمين في دولة الإمارات الذين عززوا مستقبلهم المالي من خلال تقييمنا الشامل.",
    save_results_no_passwords:
      "احفظ نتائجك بمجرد بريدك الإلكتروني وتاريخ ميلادك - لا حاجة لكلمات مرور!",
    ...
    provide_information_personalize:
      "يرجى تقديم معلوماتك لتخصيص تقييم صحتك المالية",
    personal_information: "المعلومات الشخصية",
    basic_demographic_information:
      "معلوماتك الديموغرافية الأساسية لتخصيص التقييم",
    name: "الاسم",
    ...
    pdf_generation_in_progress: "إنشاء PDF قيد التقدم",
    failed_to_generate_pdf: "فشل في إنشاء PDF",
    failed_to_download_pdf: "فشل في تنزيل PDF",
    sending_email_report: "جاري إرسال التقرير عبر البريد الإلكتروني...",
    email_sent_successfully: "تم إرسال البريد الإلكتروني بنجاح!",
    email_service_being_configured: "خدمة البريد الإلكتروني قيد التكوين",
    failed_to_send_email: "فشل في إرسال البريد الإلكتروني",
    email_address_not_available: "عنوان البريد الإلكتروني غير متوفر",
    no_assessment_data_found: "لم يتم العثور على بيانات التقييم",
    loading_your_assessments: "جاري تحميل تقييماتك...",

    // Category names for history page
    income_stream: "تدفق الدخل",
    savings_habit: "عادات الادخار",
    emergency_savings: "مدخرات الطوارئ",
    debt_management: "إدارة الديون",
    retirement_planning: "التخطيط للتقاعد",
    protecting_your_family: "حماية عائلتك",
