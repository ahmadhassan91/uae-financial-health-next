...
export const translations = {
  en: {
    ...
    'no_previous_assessments': 'No previous assessments found. Complete your first assessment to start tracking your progress.',
    'back_to_assessment': 'Back to Assessment',
    'track_your_financial_health_progress': 'Track your financial health progress over time',
    ...
    'your_financial_health_score_progression': 'Your financial health score progression over time',
    'current_pillar_analysis': 'Current Pillar Analysis',
    'breakdown_of_your_latest_score': 'Breakdown of your latest score by the 6 financial health pillars',
    'assessment_history': 'Assessment History',
    'detailed_view_of_all_assessments': 'Detailed view of all your completed assessments',
    'latest': 'Latest',
  ...
  ar: {
    ...
    'no_previous_assessments': 'لم يتم العثور على تقييمات سابقة. أكمل تقييمك الأول لبدء تتبع تقدمك.',
    ...
    'your_financial_health_score_progression': 'تطور درجة صحتك المالية بمرور الوقت',
    'current_pillar_analysis': 'تحليل الركائز الحالي',
    'breakdown_of_your_latest_score': 'تفصيل آخر درجة لك حسب الركائز الست للصحة المالية',
