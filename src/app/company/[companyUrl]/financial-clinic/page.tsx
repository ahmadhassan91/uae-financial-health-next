...
export default function CompanyFinancialClinicPage() {
  ...
  useEffect(() => {
    const validateCompany = async () => {
      try {
        // Check if there's a session parameter for resume functionality
        ...
        // Redirect to Financial Clinic with company parameter in URL
        // If there's a session parameter, include it for resume functionality
        setTimeout(() => {
          if (sessionId) {
