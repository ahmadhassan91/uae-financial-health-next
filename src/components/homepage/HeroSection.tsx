...
export function HeroSection() {
  ...
  return (
    <section className="flex w-full relative flex-col items-center gap-[65px] px-4 py-[65px]">
      ...
      <div
        className="w-full h-[500px] md:h-[647px] overflow-hidden bg-cover bg-center bg-no-repeat relative rounded-lg"
        style={{ backgroundImage: "url(/homepage/images/frame-9.png)" }}
      >
        <div className="absolute right-0 w-full md:max-w-[647px] h-full flex bg-[#ffffffe6] opacity-90">
