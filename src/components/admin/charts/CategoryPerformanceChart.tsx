...
export function CategoryPerformanceChart({ data }: CategoryPerformanceChartProps) {
  ...
  const filteredData = Array.isArray(data) ? filterFinancialKnowledge(data) : [];
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Average scores across 5 financial health categories</CardDescription>
      </CardHeader>
      <CardContent>
        {chartData.length === 0 ? (
