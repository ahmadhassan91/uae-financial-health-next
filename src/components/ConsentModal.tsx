    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-2 sm:p-4">
      <div className="bg-white rounded-[10px] shadow-lg max-w-[884px] w-full max-h-[95vh] sm:max-h-[90vh] flex flex-col">
        ...
        <div className="px-4 sm:px-6 md:px-8 py-3 sm:py-4 md:py-6 space-y-3 sm:space-y-4 md:space-y-8 overflow-y-auto flex-1 max-h-[25vh] sm:max-h-[35vh] md:max-h-none">
          {/* What We Collect */}
          <div className="bg-[#f2f5f7] rounded-lg p-3 sm:p-4 md:p-[18px]">
            <h3 className="font-normal text-[#767f87] text-sm sm:text-base leading-5 sm:leading-6 mb-2 sm:mb-3">
              {language === "ar" ? "الشروط والأحكام" : "Terms & Conditions"}
            </h3>
          ...
          <div className="bg-[#f2f5f7] rounded-lg p-3 sm:p-4 md:p-[18px]">
            <h3 className="font-normal text-[#565d63] text-sm sm:text-base leading-5 sm:leading-6 mb-2">
              {language === "ar"
...
الصكوك الوطنيّة أيّ إقرارات، أو ضمانات بشأن دقّة أو فعاليّة أو أداء أيّ برمجيّات لجهات خارجية قد يجري استخدامها فيما يتعلق بهذا الموقع. قد تكون لكم حقوق وسبل انتصاف متاحة فيما يتعلق بتقديم الصكوك الوطنية للخدمات، والتي لا يمكن استثناؤها أو تقييدها أو تعديلها ("حقوق غير قابلةٍ للاستثناء"). لا تستثني الصكوك الوطنية أياً من تلك الحقوق غير القابلة للاستثناء، ولكنّها تستثني أيّ شروط وضمانات أخرى مفترضة بموجب العرف أو القانون أو اللوائح. تقتصر مسؤولية الصكوك الوطنية عن أيّ انتهاك لأيّ من الحقوق غير القابلة للاستثناء، وفقاً لتقديرها، على إعادة تقديم الخدمات أو دفع تكلفة إعادة تقديمها.`
        ...
        <div className="px-4 sm:px-6 md:px-8 py-3 sm:py-4 md:py-6 border-t border-gray-100 flex-shrink-0">
          <div className="space-y-2 sm:space-y-3">
            ...
            {/* Profiling Consent */}
            <div className="p-2.5 sm:p-3 md:p-4 border border-gray-200 rounded-lg hover:border-green-300 transition-colors">
